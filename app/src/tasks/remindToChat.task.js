...
exports.remindToChatTask = void 0;
...
var RemindToChatTask = /** @class */ (function () {
    function RemindToChatTask() {
    }
    RemindToChatTask.prototype.setup = function (args, db, timer) {
        return __awaiter(this, void 0, void 0, function () {
            var settingsId, botSettingsId, delay, time, exitingTask, dbTask, st;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, global_settings_1.getGlobalSettingsId(db)];
                    case 1:
                        settingsId = _a.sent();
                        if (!args.chatId) {
                            logger_1.logT.error("Missing Argument in remindToChatSchedule", Error);
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, db
                    ...
                    case 4:
                        exitingTask = (_a.sent())[0];
                        st = {
                            taskType: args.taskType,
                            chatId: args.chatId,
                            scheduledFor: time.toDate()
                        };
                        if (!!exitingTask) return [3 /*break*/, 6];
                    ...
                    case 7:
                        ...
                        _a.label = 8;
                    case 8:
                        logger_1.logT.info("Rescheduling BOT_REMIND_TO_CHAT message in " + logger_1.logFormat(delay));
    ...
    RemindToChatTask.prototype.schedule = function (dbTask, db) {
        return __awaiter(this, void 0, void 0, function () {
            var t;
            return __generator(this, function (_a) {
                t = {
                    ...
                    callback: function (task, done) {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, exports.remindToChatTask.execute(dbTask, db)];
                                    case 1:
                                        _a.sent();
                                        done();
                                        return [2 /*return*/];
    ...
    RemindToChatTask.prototype.condition = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RemindToChatTask.prototype.execute = function (task, db) {
        return __awaiter(this, void 0, void 0, function () {
            var settingsId, botSettingsId, chatText, botId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logT.info("Executing BOT_REMIND_TO_CHAT callback");
    ...
    return RemindToChatTask;
}());
exports.remindToChatTask = new RemindToChatTask();
