...
exports.phqReminderPushFollowup = void 0;
var tasks_1 = require("./tasks");
var logger_1 = require("../logger");
var moment = require("moment");
var NotificationService_1 = require("../services/notification/NotificationService");
var PhqReminderPushFollowup = /** @class */ (function () {
    function PhqReminderPushFollowup() {
    }
    PhqReminderPushFollowup.prototype.setup = function (args, db, timer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!args.userId) {
                            logger_1.logT.error("Missing Argument in scheduleNotifyPhqReminderFollowup", Error);
                            return [2 /*return*/];
                        }
                    ...
                    case 4:
                        dbTask = _a.sent();
                        logger_1.logT.info("Scheduling PUSH_NOTIFY_PHQ_REMINDER_FOLLOWUP for " + scheduleTime.toISOString());
                        return [2 /*return*/, this.schedule(dbTask, db)];
                }
            });
        });
    };
    PhqReminderPushFollowup.prototype.schedule = function (dbTask, db) {
        return __awaiter(this, void 0, void 0, function () {
            var t;
            return __generator(this, function (_a) {
                t = {
                    ...
                    callback: function (task, done) {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                exports.phqReminderPushFollowup.execute(dbTask, db);
                                done();
                                return [2 /*return*/];
                            });
                        });
    ...
    PhqReminderPushFollowup.prototype.condition = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    PhqReminderPushFollowup.prototype.execute = function (task, db) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
    ...
    return PhqReminderPushFollowup;
}());
exports.phqReminderPushFollowup = new PhqReminderPushFollowup();
